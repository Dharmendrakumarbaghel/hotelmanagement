<?php
    ...
    if(isset($_POST['add'])){
        ...
        $status=$_POST['status'];
        $data="insert into roomtype (room_type,status)values('$room_type','$status')";
                    ...
                    <div class="row mt-4 mb-2">
                        ...
                        <div class="col-sm-8 border">
                            <div class="">
                                ...
                                <?php
                                    if($check==0){
                                        echo "New User roomtype ";
                                    }
                                    else{
                                        echo "roomtype update ";
                                    }
                                ?>
                                </h1>
                        ...
                        <div class="container">
                            <form method="POST">
                                <div class="form-group mt-4">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Enter your roomtype" name="room_type" value="<?php echo $room_type;?>" />
                                </div>
                                <?php
                                    if($check==0){
                                ?>
